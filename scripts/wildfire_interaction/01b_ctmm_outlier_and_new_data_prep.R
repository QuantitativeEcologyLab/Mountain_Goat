...
# Script description: cleaning new GPS tracking data (Sept 2023 to Feb 2025)
...
new_collar[duplicated(new_collar[, c("acq_time_utc", "latitude_deg", "longitude_deg", "collar_id")]), ]
...
# check each individual one at a time
...
# location checks, visually inspect locations, plot 10 points before and after point that is in question
...
test <- goat[-10:10 + which(goat$x >= 6000 &
                              goat$y >= -1000), ]
# rowname 485, point 485 is included from above
...
# streamlined once above has been checked
...
# save cleaned data df during wildfire period for all years
