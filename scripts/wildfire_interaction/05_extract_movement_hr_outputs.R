...
# inspect if all the units are the same (units = km²), units = FALSE, default units are m^2
hr_size
...
# extracting movement results all at once instead of sections independently (see below to extract them individually)
